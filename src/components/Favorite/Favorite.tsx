...
const Favorite: React.FC = () => {
    ...
    const handleAddFavorite = async (id: number) => {
        ...
        try {
            ...
            await submitForm("/favorites/toggle/", formData, navigate);
    ...
    return (
        <div className="w-75">
            {!isLoggedIn ? (
                <div>
                    <div>
                        <img className="w-100 d-inline-block my-5 " src="Img/favorites-list-empty.svg" width="200" height="150" alt="empty-cart" style={{ objectFit: "contain" }} />
                        <p className="d-flex justify-content-center fs-4 fw-bold">نیاز به ورود دارید!</p>
                        <p className="d-flex justify-content-center fw-light">برای مشاهده محصولات موردعلاقه خود ، وارد حساب کاربریتان شوید.</p>
                    </div>
                </div>
            ) : (
                <div>
                    {status === 100 ? (
                        <div className=" my-5 ">
                            <img className="w-100 d-inline-block my-5 " src="Img/favorites-list-empty.svg" width="200" height="150" alt="empty-cart" style={{ objectFit: "contain" }} />
                            <p className="d-flex justify-content-center fs-5">لیست علاقه‌مندی‌های شما خالی است.</p>
                        </div>
                    ) : (
                        <ProductRow
