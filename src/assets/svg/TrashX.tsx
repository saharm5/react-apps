...
export default function Trash() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="14px" height="14px">
            <path
                fill="rgb(19 62 135)"
                stroke="rgb(19 62 135)" // Set the stroke color to white (or any color you prefer)
                strokeWidth="1" // Increase strokeWidth for a bolder outline
