...
export default function Trash() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="17px" height="18px">
            <path
                fill="white"
                stroke="white" // Set the stroke color to white (or any color you prefer)
